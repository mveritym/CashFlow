...
public class CashFlow extends JavaPlugin {
   ...
   public void onEnable() {
      ...
      // Register Listener
      getServer().getPluginManager().registerEvents(new CashFlowListener(this),
            this);
      // Grab Permissions
      ...
      getCommand("salary").setExecutor(new SalaryCommand(this, salaryManager));
       ...
       * config, taxManager, salaryManager, prefix), (long) (config.catchUpDelay
       * * tickToHour)); if (id == -1) {
