...
public enum LocalString {
   ...
   INVALID_NAME(LocalizeConfig.invalidName),
   UNKNOWN_COMMAND(LocalizeConfig.unknownCommand),
   COMMAND_CASHFLOW_RESTART(LocalizeConfig.restart),
   COMMAND_CASHFLOW_ENABLE(LocalizeConfig.cashflowEnable),
   COMMAND_CASHFLOW_DISABLE(LocalizeConfig.cashflowDisable);
