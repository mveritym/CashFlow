...
public class Methods {
    ...
    private static void _init() {
        addMethod("iConomy", new com.nijikokun.cashflowregister.payment.methods.iCo6());
        addMethod("iConomy", new com.nijikokun.cashflowregister.payment.methods.iCo5());
        addMethod("iConomy", new com.nijikokun.cashflowregister.payment.methods.iCo4());
        addMethod("BOSEconomy", new com.nijikokun.cashflowregister.payment.methods.BOSE6());
        addMethod("BOSEconomy", new com.nijikokun.cashflowregister.payment.methods.BOSE7());
        addMethod("Essentials", new com.nijikokun.cashflowregister.payment.methods.EE17());
        addMethod("Currency", new com.nijikokun.cashflowregister.payment.methods.MCUR());
