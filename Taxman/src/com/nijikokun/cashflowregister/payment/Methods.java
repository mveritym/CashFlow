package com.nijikokun.cashflowregister.payment;
...
public class Methods {
     ...
     */
    private void _init() {
        this.addMethod("iConomy", new com.nijikokun.cashflowregister.payment.methods.iCo6());
        this.addMethod("iConomy", new com.nijikokun.cashflowregister.payment.methods.iCo5());
        this.addMethod("iConomy", new com.nijikokun.cashflowregister.payment.methods.iCo4());
        this.addMethod("BOSEconomy", new com.nijikokun.cashflowregister.payment.methods.BOSE6());
        this.addMethod("BOSEconomy", new com.nijikokun.cashflowregister.payment.methods.BOSE7());
        this.addMethod("Essentials", new com.nijikokun.cashflowregister.payment.methods.EE17());
        this.addMethod("MultiCurrency", new com.nijikokun.cashflowregister.payment.methods.MCUR());
    }
